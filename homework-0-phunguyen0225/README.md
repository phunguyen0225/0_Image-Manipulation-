...
Due Date: Tue 09/14/21 11:59 PM

**1.  Image Merging:**

(10 pts.) Write a code to merge two images of the computer scientist *Grace Hopper*. In 1952, *Grace Hopper* and her team created the first compiler for computer languages.
...
(10 pts.) Write a code to scale the intensity of the left half of the merged image by scaling factor of alpha and the right half by a scaling factor of beta. 
...
(10 pts.) Write a code to centralize the intensities of the two sections of the image.
